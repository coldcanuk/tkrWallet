/* tkrWallet QR encoder.
 * Bundled from uqr (MIT). Copyright (c) Project Nayuki; Copyright (c) 2023 Anthony Fu.
 * Encode only — the wallet draws modules on a canvas. Never insert HTML.
 */
var tkrQr = (() => {
  ...
  // tools/qr-entry.js
  var qr_entry_exports = {};
  __export(qr_entry_exports, {
    encode: () => encode
  });
  ...
  return __toCommonJS(qr_entry_exports);
})();
if(typeof module==='object'&&module.exports)module.exports=tkrQr;

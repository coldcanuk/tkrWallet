...
| W8 | **Stale custody doc** still says the production edge is not deployed. | Reviewers will distrust every other claim. | Point `wallet-custody.md` at this review and the live hostname. |
